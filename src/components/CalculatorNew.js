...
export default function Calculator() {
    ...
    const [
        {
            ...
            conditionCard,
            bonusCritic
        }, setDamageCalculation] = useState(damageFormule);

    const bonusSkill = (cardDamage * skill) / 500

    const [style, setStyle] = useState({ display: 'none' });
    const [styleSimple, setStyleSimple] = useState({ display: 'flex' });
    const [styleAdvance, setStyleAdvance] = useState({ display: 'none' });
    const [styleDamage, setStyleDamage] = useState({ display: 'none' });
    ...
    const [styleBackgroundD, setStyleBackgroundD] = useState({ backgroundColor: 'wheat' });

    const [styleBackgroundDS, setStyleBackgroundDS] = useState({ backgroundColor: 'wheat' });
    const [styleBackgroundDA, setStyleBackgroundDA] = useState({ backgroundColor: 'wheat' });
    ...
    const infoTextChangeDamage = 'Presiona para ir a la calculadora de daño';
    ...
    const handleChangeDamageCalculator = () => {
        setStyleAdvance({ display: 'none' });
        setStyleSimple({ display: 'none' });
        setStyleDamage({ display: 'flex' });
        setStyleBackgroundS({ backgroundColor: 'wheat' });
        setStyleBackgroundA({ backgroundColor: 'wheat' });
        setStyleBackgroundD({ backgroundColor: '#a59577' });
    };

    const handleDamageSimple = () => {
        setDamageCalculation(prevState => ({ ...prevState, conditionCard: 0.94 }));
        setStyleBackgroundDS({ backgroundColor: '#a59577' });
        setStyleBackgroundDA({ backgroundColor: 'wheat' });
        setStyleBackgroundDD({ backgroundColor: 'wheat' });
    };

    const handleDamageCombo = () => {
        setDamageCalculation(prevState => ({ ...prevState, conditionCard: 0.988 }));
        setStyleBackgroundDS({ backgroundColor: 'wheat' });
        setStyleBackgroundDA({ backgroundColor: '#a59577' });
        setStyleBackgroundDD({ backgroundColor: 'wheat' });
    };

    const handleDamageCondition = () => {
        setDamageCalculation(prevState => ({ ...prevState, conditionCard: 1.2 }));
        setStyleBackgroundDS({ backgroundColor: 'wheat' });
        setStyleBackgroundDA({ backgroundColor: 'wheat' });
        ...
        <div className="col-12 d-flex flex-column justify-content-center align-items-center">
            ...
            <section className="calculator-container col-12 d-flex justify-content-evenly align-items-center">
                <div className="calculator-section">
                    <section className="calculator-button-advance d-flex justify-content-around">
                        <button
                            className="col-3 change-simpe"
                        ...
                        <button
                            className="col-3 change-advance"
                        ...
                        <button
                            className="col-3 change-advance"
                            style={styleBackgroundD}
                            onClick={handleChangeDamageCalculator}
                            onMouseEnter={e => {
                                setStyle({ display: 'block' })
                                setInfoText(infoTextChangeDamage)
                            }} onMouseLeave={e => { setStyle({ display: 'none' }) }}
                        >
                            Daño
                        </button>
                    ...
                    <section className="card">
                        <div className="card-header">
                            <div className="calculator-header">
                                <div className="Header-calculador">
                                    <h3 className="justify-content-center align-items-center" style={styleSimple}>
                                        <button
                                ...
                                <div className="options-calculator justify-content-around align-items-center mt-3 mb-3" style={styleDamage}>
                                    <button style={styleBackgroundDS} className="btn" onClick={handleDamageSimple}>simple</button>
                                    <button style={styleBackgroundDA} className="btn" onClick={handleDamageCombo}>en combo</button>
                                    <button style={styleBackgroundDD} className="btn" onClick={handleDamageCondition}>condicionado</button>
                                </div>
                            </div>
                        ...
                        <div className="card-body">
                            <div className="card-body-content card-body-simple">
                                <div className="justify-content-center" style={styleSimple}>
                                    <button
                            ...
                            <div className="card-body-content">
                                <div className="flex-column" style={styleSimple}>
